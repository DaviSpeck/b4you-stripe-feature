...
export const PlanItemStandard = (props: iProps) => {
  const { plan, defaultPlan, planId = "", onClick = () => null } = props;
  ...
  return (
    <li
      className={cn("cursor-pointer rounded-[6px] border border-[#1a1a1a1a]")}
      onClick={onClick}
    >
        ...
        <div className="flex w-full flex-col gap-2">
          <div className="flex w-full items-center gap-1">
            ...
            <div className="flex w-full flex-wrap items-center gap-1">
              {savingMoney > 0 && (
                <span className="h-fit rounded-[4px] bg-[#cbf4c9] px-1.5 py-0.5 text-[0.62rem] font-medium whitespace-nowrap text-[#0e6245]">
                  Economize{" "}
