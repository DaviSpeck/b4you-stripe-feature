...
const PageAppsListMemberkit = () => {
  ...
  const handleEdit = (item) => {
    history.push(`/apps/memberkit/${item.uuid}`);
  };

  const handleDelete = () => {
    api
      .delete(`/integrations/memberkit/${itemCancel.uuid}`)
      .then(() => {
        fetchData();
...
export default PageAppsListMemberkit;
