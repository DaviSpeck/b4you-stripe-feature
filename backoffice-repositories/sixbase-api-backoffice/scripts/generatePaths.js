...
function scanDirectory(dir, basePath, combinedPaths, modulesFound, docsDir) {
    ...
    let currentModulesFound = modulesFound;
    ...
    items.forEach(item => {
        ...
        if (stat.isDirectory()) {
            ...
            currentModulesFound = scanDirectory(fullPath, path.join(basePath, item), combinedPaths, currentModulesFound, docsDir);
...
function generatePaths() {
    ...
    try {
        ...
        modulesFound = scanDirectory(modulosDir, '', combinedPaths, modulesFound, docsDir);
