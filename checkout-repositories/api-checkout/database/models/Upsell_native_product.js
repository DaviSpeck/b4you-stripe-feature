...
class Upsell_native_product extends Sequelize.Model {
    ...
    super.init(
      {
        ...
        title_size: { type: Sequelize.DECIMAL(3, 3), defaultValue: 24 },
        ...
        subtitle_one_size: { type: Sequelize.DECIMAL(3, 3), defaultValue: 24 },
        ...
        subtitle_two_size: { type: Sequelize.DECIMAL(3, 3), defaultValue: 24 },
      ...
      },
      {
        ...
        underscored: true,
        sequelize,
        modelName: 'upsell_native_product',
      },
    );
...
module.exports = Upsell_native_product;
