...
module.exports.createAstronmembersIntegrationController = async (
  req,
  res,
  next,
) => {
...
module.exports.getAstronmembersIntegrationsController = async (
  req,
  res,
  next,
) => {
...
module.exports.createAstronmembersProductIntegrationsController = async (
  req,
  res,
  next,
) => {
...
module.exports.getAstronmembersProductsController = async (req, res, next) => {
  const {
    params: { plugin_id: uuid },
    user: { id: id_user },
  } = req;
