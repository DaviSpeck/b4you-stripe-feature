  ...
  return (
    <>
      ...
      <section id='page-apps'>
        <img src={logoShopify} className='logo-app' alt='Shopify' />
        <Card className='mt-4'>
          <Card.Body>
            <Table responsive>
              <thead>
                  ...
                  credentials.map((item, index) => {
                    return (
                      <tr className='text-center' key={index}>
                        <td className='d-flex justify-content-center shopify-status-cell'>
                          <div>
                            {item.active ? (
                        ...
                        <td className='d-flex justify-content-center shopify-action-cell'>
                          <ButtonDS
                            size='icon'
                            variant='danger'
                            onClick={() => {
...
export default PageAppsShopify;
