...
class Product_affiliate_settings extends Sequelize.Model {
  static init(sequelize) {
    super.init(
      ...
      {
        hooks: {
          beforeCreate: (product_affiliate_settings) => {
            product_affiliate_settings.uuid = uuid.v4();
          },
        },
...
module.exports = Product_affiliate_settings;
