...
const { refundProductor } = require('../../../../mails/messages');
const { capitalizeName, formatBRL } = require('../../../../utils/formatters');

class StudentRefundRequestProducer extends MailService {
  constructor(data) {
  ...
  async send() {
    ...
    const variables = refundProductor(
...
module.exports = StudentRefundRequestProducer;
