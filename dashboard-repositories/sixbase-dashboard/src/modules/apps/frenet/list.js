  ...
  return (
    <>
      ...
      <section id='page-apps'>
        <img src={logoFrenet} className='logo-app' alt='Frenet' />
        <Card className='mt-4'>
          <Card.Body>
            <Table responsive>
              <thead>
