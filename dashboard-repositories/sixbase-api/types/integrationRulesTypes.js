const integrationRulesTypes = [
  ...
  {
    id: 12,
    label: 'Solicitação de afiliação',
    key: 'affiliate-request',
  },
  {
    id: 13,
    label: 'Afiliação aprovada',
    key: 'approved-affiliate',
  },
  {
    id: 14,
    label: 'Afiliação recusada',
    key: 'refused-affiliate',
  },
];

const findRulesTypes = (type) => {
