...
const CheckoutPersonalizeTab = ({ productUuid, product, setProduct }) => {
        ...
        if (file) {
          ...
          try {
            const response = await api.put(
              `/products/images/${productUuid}/header-mobile`,
              formData,
              {
                headers: {
  ...
  const onSubmit = (data) => {
    ...
    if (fields.hex_color && (fields.hex_color.length !== 7 || fields.hex_color.includes('_'))) {
    ...
    api
      .put(
        `/products/${productUuid}/checkout/customizations`,
  ...
  const putEmbed = () => {
    api
      .put(`/products/video/${productUuid}`, {
        embed,
      })
      .then(() => {
  ...
  const removeEmbed = () => {
    setIsRemoving(true);
    api
      .delete(`/products/video/${productUuid}`)
      .then(() => {
        setEmbed(null);
              ...
              <Card.Body>
                <Row>
                  <Col md={4}>
                    ...
                    <UploadImage
                      route={`/products/logo/${productUuid}`}
                      multiple={false}
                      field={'logo'}
                      update={'logo'}
                  ...
                  <Col md={4}>
                    ...
                    <UploadImage
                      route={`/products/images/${productUuid}/favicon`}
                      multiple={false}
                      field={'favicon'}
                      update={'favicon'}
                    ...
                    <Col className='form-group' md={6}>
                      ...
                      <div className='c-picker'>
                        <Form.Control
                          ...
                          defaultValue={product?.hex_color || '#563d7c'}
                ...
                <Card.Body>
                  <Row>
                    <Col className='form-group' md={12}>
                      ...
                      <UploadImage
                        route={`/products/images/${productUuid}/${item.field}`}
                        multiple={false}
                        field={item.field}
                        update={item.snake}
                        setImg_link={(link) => {
...
export default CheckoutPersonalizeTab;
