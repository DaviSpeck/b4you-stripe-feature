...
case "$ENVIRONMENT" in
  production|prod)
    FUNCTION_NAME="b4you-production-paidPayment"
    ;;
  sandbox|sbx|staging)
    FUNCTION_NAME="b4you-sandbox-paidPayment"
    ;;
  *)
...
echo "=========================================="
echo "Deploy do Lambda paidPayment ($ENVIRONMENT)"
echo "=========================================="
