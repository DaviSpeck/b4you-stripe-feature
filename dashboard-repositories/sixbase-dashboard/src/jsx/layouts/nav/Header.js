...
import profile_picture_image from '../../../images/avatar/0.png';
...
const Header = ({ toggle, onProfile }) => {
  ...
  const logout = () => {
    ...
    api.get(`/auth/logout?device_id=${device_id}`).then(() => {
          ...
          <div className='collapse navbar-collapse justify-content-between'>
            ...
            <ul className='navbar-nav header-right'>
              ...
              <li className='nav-item dropdown notification_dropdown'>
                ...
                >
                  <PerfectScrollbar
                    ...
                    className={` widget-media dz-scroll p-3 height200 ${
                          ...
                          >
                            <div className='timeline-panel'>
                              ...
                              <div className='media-body'>
                                <h6 className='mb-1'>{element.title}</h6>
                  ...
                  <Link className='all-notification' to='/notificacoes'>
                    Ver Todas Notificações <i className='ti-arrow-right' />
                  </Link>
                </div>
              </li>
              <li className='nav-item dropdown header-profile'>
                ...
                >
                  <img
                    src={user ? user.profile_picture : profile_picture_image}
                    width={20}
                    alt={''}
                  />
                </Link>
                <div
                  ...
                  style={{ marginTop: '-30px' }}
                >
                  <Link to='/configuracoes' className='dropdown-item ai-icon'>
                    <svg
                      id='icon-user1'
                      xmlns='http://www.w3.org/2000/svg'
                  ...
                  {/* <Link to='/colaboradores' className='dropdown-item ai-icon'>
                    <svg
                      id='icon-user1'
                      xmlns='http://www.w3.org/2000/svg'
                      className='text-primary'
