...
>((props, ref) => {
  ...
  const recalcInstallments = useInstallmentTwoCards(
    (state) => state.recalcInstallments,
  );
  const cardOneInstallmentSelected = useInstallmentTwoCards(
    (state) => state.cardOneInstallmentSelected,
  );
  const cardOneInstallments = useInstallmentTwoCards(
    (state) => state.cardOneInstallments,
  );
