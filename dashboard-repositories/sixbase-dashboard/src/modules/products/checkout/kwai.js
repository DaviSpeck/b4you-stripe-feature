...
const Kwai = ({ rows, title, titleModal, fetchData, companyId }) => {
...
const ModalAds = ({
  ...
  const onSubmit = (data) => {
    ...
    const tmpPixelId = data.pixel_id.split('/');
    fields.pixel_id = tmpPixelId[0];
    fields.purchase_label = tmpPixelId[1];
