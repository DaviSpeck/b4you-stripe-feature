...
export const PlanItemWithUpsell = (props: iProps) => {
  ...
  return (
    <li
      className={cn("rounded-[6px] border border-[#1a1a1a1a]")}
      onClick={onClick}
    >
      <div className="p-3 pb-2.5">
        ...
        <p className="text-[0.75rem] font-normal">
          ...
          {
            frequencyDictionary[
            planId === upsellPlan.uuid ? upsellPlan.frequency : plan.frequency
            ]
          }
        </p>
        ...
        <div className="flex w-full flex-col gap-2">
          <div className="flex w-full items-center gap-1">
            <div className="flex w-full flex-wrap items-center gap-1">
              ...
              <span className="h-fit shrink-0 rounded-[4px] bg-[#cbf4c9] px-1.5 py-0.5 text-[0.62rem] font-medium text-[#0e6245]">
                Economize{" "}
              ...
              <div className="flex w-full min-w-47.5 flex-1 flex-wrap items-center justify-between gap-2">
                <span className="shrink-0 text-[0.625rem] font-medium">
                  com cobrança {frequencyDictionary[normalizeFrequency(upsellPlan.frequency)]}
                </span>
                <span className="shrink-0 text-[0.7rem] font-medium">
